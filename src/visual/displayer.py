...
from src.resources import position, constants
...
class Displayer:
    ...
    def __init__(self):
        ...
        self.font = pg.font.SysFont('Hiragino Sans GB', 28)
        self.font_s = pg.font.SysFont('Hiragino Sans GB', 18)
        ...
        if game.get_game().day_time > 0.75 or game.get_game().day_time < 0.4:
            ...
            if lv:
                ...
                light = pygame_lights.LIGHT(lv * 150, pygame_lights.pixel_shader(lv * 150,
                                                                                 (255, 127, 0) if player.weapons[player.sel_weapon] is not weapons.WEAPONS['nights_edge'] and player.weapons[player.sel_weapon] is not weapons.WEAPONS['true_nights_edge'] else (127, 0, 127), 1, False))
