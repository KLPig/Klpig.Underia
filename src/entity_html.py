...
ets = [
    'Tree', 'TreeMonster', 'ClosedBloodflower', 'Eye', 'Bloodflower', 'RedWatcher', 'Star', 'SwordInTheStone',
    'Cactus', 'TrueEye', 'MagmaCube', 'MagmaKing', 'RuneRock', 'SandStorm', 'AbyssEye', 'EvilMark', 'SoulFlower',
    'MechanicEye', 'Cells', 'FaithlessEye', 'TruthlessEye', 'Destroyer', 'TheCPU', 'Greed', 'EyeOfTime'
    ]
